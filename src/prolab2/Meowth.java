...
public class Meowth extends Pokemon {
    //resim eklenecek
    private String resimUzantı = "C:/Users/x/Documents/NetBeansProjects/PROLAB2/src/prolab2/fotolar/Meowth.jpg";
    private ImageIcon resim = new ImageIcon(resimUzantı);
    private int hasarPuani = 40;
    public int kullanma1=0;
    //yapıcılar oluşturulacak
    public Meowth(int hasarpuani, int pokemonID, String pokemonAdi, String pokemonTip) {
