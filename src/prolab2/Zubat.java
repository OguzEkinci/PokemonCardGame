...
public class Zubat extends Pokemon {
    //resim eklenecek
    private String resimUzantı = "C:/Users/x/Documents/NetBeansProjects/PROLAB2/src/prolab2/fotolar/Zubat.jpg";
    private ImageIcon resim = new ImageIcon(resimUzantı);
    private int hasarPuani = 50;
    public int kullanma1=0;
    //yapıcılar oluşturulacak
    public Zubat(int hasarpuani, int pokemonID, String pokemonAdi, String pokemonTip) {
