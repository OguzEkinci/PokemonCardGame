...
public class Jigglypuff extends Pokemon {
    //resim eklenecek
    private String resimUzantı = "C:/Users/x/Documents/NetBeansProjects/PROLAB2/src/prolab2/fotolar/Jigglypuff.jpg";
    private ImageIcon resim = new ImageIcon(resimUzantı);
    private int hasarPuani = 70;
    public int kullanma1=0;
    //yapıcılar oluşturulacak
    public Jigglypuff(int hasarpuani, int pokemonID, String pokemonAdi, String pokemonTip) {
