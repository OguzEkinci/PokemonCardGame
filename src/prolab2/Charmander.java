...
public class Charmander extends Pokemon {
    //resim eklenecek
   private String resimUzantı = "C:/Users/x/Documents/NetBeansProjects/PROLAB2/src/prolab2/fotolar/Charmander.jpg";
    private ImageIcon resim = new ImageIcon(resimUzantı);
    private int hasarPuani = 60;
    public int kullanma1=0;
    //yapıcılar oluşturulacak
    public Charmander(int hasarpuani, int pokemonID, String pokemonAdi, String pokemonTip) {
