...
public class Bulbasaur extends Pokemon {
    //resim eklenecek
    private String resimUzantı = "C:/Users/x/Documents/NetBeansProjects/PROLAB2/src/prolab2/fotolar/Bulbasaur.jpg";
    private ImageIcon resim = new ImageIcon(resimUzantı);
    private int hasarPuani = 50;
    public int kullanma1=0;
    //yapıcılar oluşturulacak
    public Bulbasaur(int hasarpuani, int pokemonID, String pokemonAdi, String pokemonTip) {
